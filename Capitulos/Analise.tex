...
\subsection{No seu dia-a-dia de desenvolvimento, como você resolve os problemas pelos quais você passa ou como descobre como implementar algo novo pela primeira vez?}
\label{sec:dia-a-dia}
...
Assim, os casos de uso mais mencionados pelos participantes estão relacionados intimamente com políticas de gestão do conhecimento, área na qual se percebe deficiência de acordo com o notado através da pergunta \ref{sec:dia-a-dia}.
...
Uma problemática do uso da ferramenta pode ser, com o passar do tempo, o imenso volume de artefatos criados pela equipe e a possível obsolência destes. Futuras versões da ferramenta e estudos podem trabalhar em cima de mecanismos de ``esquecimento'' de artefatos.
