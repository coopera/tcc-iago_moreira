...
\begin{enumerate}
  ...
  \item A ferramenta proposta oferece suporte à maneira como conhecimento é trocado dentro de equipes de software?
  \item Que outros atributos podem ser agregados a ferramenta para melhorar este suporte, caso exista?
  \item Uma ferramenta deste tipo sozinha possui apelo entre os desenvolvedores de software?
\end{enumerate}
