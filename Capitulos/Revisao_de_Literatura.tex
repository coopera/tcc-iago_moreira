...
\begin{itemize}
  ...
  \item Sequencialidade: turnos da comunicação não podem sair de sequência.
...
% FF:Não precisa ser tão direto. A revisibilidade… por quê ela é importante para equipes de desenvolvimento e para o resuso do conhecimento? Recuperações de informações… mesma coisa… por quê é importante e que isso tem a ver com o problema que você está abordando no seu trabalho?
